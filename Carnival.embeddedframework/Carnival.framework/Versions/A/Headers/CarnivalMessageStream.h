...
/**
 *  Sets the backgroundImageView to be used as the background of the Carnival Message Stream.
 *
 *  @param backgroundImageView a UIImageView which can be set up however you wish.
 */
+ (void)setStreamBackgroundImageView:(UIImageView *)streamBackgroundImageView;

/**
 *  Sets the backgroundImageView to be used as the background of Message Detail screens (image, text
 *
 *  @param messageDetailBackgroundImageView a UIImageView which can be set up however you wish
 */
+ (void)setMessageDetailBackgroundImageView:(UIImageView *)messageDetailBackgroundImageView;
